...
./ECU_Module.src \
./In_Module_Switch_Door_Close.src \
./In_Module_Switch_Door_KidLock.src \
./In_Module_Switch_Door_OnOff.src \
./In_Module_Switch_Door_Open.src \
./Out_Module.src \
...
./ECU_Module.d \
./In_Module_Switch_Door_Close.d \
./In_Module_Switch_Door_KidLock.d \
./In_Module_Switch_Door_OnOff.d \
./In_Module_Switch_Door_Open.d \
./Out_Module.d \
...
./ECU_Module.o \
./In_Module_Switch_Door_Close.o \
./In_Module_Switch_Door_KidLock.o \
./In_Module_Switch_Door_OnOff.o \
./In_Module_Switch_Door_Open.o \
./Out_Module.o \
...
%.src: ../%.c subdir.mk
	...
	cctc -cs --dep-file="$(basename $@).d" --misrac-version=2004 -D__CPU__=tc27xd "-fC:/gitRepo_autoDoor/AutoDoor/TriCore Debug (TASKING)/TASKING_C_C___Compiler-Include_paths__-I_.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc27xd -Y0 -N0 -Z0 -o "$@" "$<" && \
...
In_Module_Switch_Door_Close.o: ./In_Module_Switch_Door_Close.src subdir.mk
	@echo 'Building file: $<'
	@echo 'Invoking: TASKING Assembler'
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"
	@echo 'Finished building: $<'
...
In_Module_Switch_Door_KidLock.o: ./In_Module_Switch_Door_KidLock.src subdir.mk
	@echo 'Building file: $<'
	@echo 'Invoking: TASKING Assembler'
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"
	@echo 'Finished building: $<'
...
In_Module_Switch_Door_OnOff.o: ./In_Module_Switch_Door_OnOff.src subdir.mk
	@echo 'Building file: $<'
	@echo 'Invoking: TASKING Assembler'
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"
	@echo 'Finished building: $<'
...
In_Module_Switch_Door_Open.o: ./In_Module_Switch_Door_Open.src subdir.mk
	@echo 'Building file: $<'
	@echo 'Invoking: TASKING Assembler'
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"
	@echo 'Finished building: $<'
